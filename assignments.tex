...
\section{Exercises}
    ...
    \input{./exercises/simple_stuff/assignments.tex}

    \subsection{Drawings \& Lists}
    \input{./exercises/drawings_and_lists/assignments.tex}

    \subsection{Dictionaries \& Sets}
    \input{./exercises/dictionaries_and_sets/assignments.tex}

    \subsection{Graphs \& Networks}

\section{Labs}
    \input{./labs/lab1/assignments.tex}
